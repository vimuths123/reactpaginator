...
function paginationNoAjax(jsonarrray, perpage, contentdiv, numberplate){
                var PaginateContent = React.createClass({
                    getInitialState: function() {
                        return {
                            json: jsonarrray.slice(0, perpage)
                        };
                    },

                    edit: function(id){
                        var startpoint = (id * perpage) - perpage;
                        var arr = jsonarrray.slice(startpoint, (parseInt(startpoint) + parseInt(perpage)));
                    ...
                    render: function(){                        
                        ...
                        $(document).ready(function () {            
                            var options = {
                                currentPage: 1,
                                totalPages: Math.ceil(jsonarrray.length / perpage),
                                itemTexts: function (type, page, current) {
                                    switch (type) {
                                        case "first":
                                            return "First";
